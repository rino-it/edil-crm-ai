...
export default async function ScadenzeLayout({
  ...
  return (
    <div className="animate-in fade-in duration-300">
      ...
      <div>
        <h1 className="text-xl md:text-3xl font-bold tracking-tight text-foreground">Scadenziario</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="shadow-[var(--shadow-sm)] border-border/60">
          ...
          <CardContent className="pt-3 md:pt-4">
            <div className="text-lg md:text-2xl font-bold text-rose-700">{formatEuro(kpis.daPagare)}</div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-[var(--shadow-sm)] border-border/60">
          ...
          <CardContent className="pt-3 md:pt-4">
            <div className="text-lg md:text-2xl font-bold text-emerald-700">{formatEuro(kpis.daIncassare)}</div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-[var(--shadow-sm)] border-border/60">
          ...
          <CardContent className="pt-3 md:pt-4">
            <div className="text-lg md:text-2xl font-bold text-amber-700">{formatEuro(kpis.scaduto)}</div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-[var(--shadow-sm)] border-border/60">
          ...
          <CardContent className="pt-3 md:pt-4">
            <div className="text-lg md:text-2xl font-bold text-blue-700">{kpis.daSmistare}</div>
